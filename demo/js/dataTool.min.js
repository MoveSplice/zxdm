...
!function (e, t) {
    ...
    function n(e, t) {
        return e ? r(u(e, "node"), function (e) {
                var r = {
                    ...
                    name: i(e, "label"),
                    itemStyle: {normal: {}}
                }, a = l(e, "viz:size"), n = l(e, "viz:position"), o = l(e, "viz:color"), s = l(e, "attvalues");
    ...
    var f = Array.prototype.map, c = (Object.freeze || Object)({
        ...
        for (var r = [], a = [], n = [], o = (t = t || []).boundIQR, i = "none" === o || 0 === o, l = 0; l < e.length; l++) {
            n.push(l + "");
            var u = s(e[l].slice()), f = p(u, .25), c = p(u, .5), d = p(u, .75), v = u[0], g = u[u.length - 1], h = (null == o ? 1.5 : o) * (d - f), b = i ? v : Math.max(v, f - h), m = i ? g : Math.min(g, d + h);
            r.push([b, f, c, d, m]);
